                ...
                <main className="terms-second-container">
                    <div className="terms-info-section">
                        <aside className='sidenav'>
                            <h2 className="bookmark">Bookmark</h2>
                            ...
                            <button className='link-buttons'>
                                    <Link href="#comms">Communication</Link>
                            </button>
                            <button className='link-buttons'>
                            ...
                            <button className='link-buttons'>
                                      <Link href="#contests">Contests, Sweepstakes and Promotions</Link>
                            </button>
                            <button className='link-buttons'>                        
                                    <Link href="#error-report">Error Reporting and Feedback</Link>
                            </button>
                            <button className='link-buttons'>                         
                                   <Link href="#subscriptions">Subscriptions</Link>
                            </button>
                            <button className='link-buttons'>                        
                                    <Link href="#links">Links to other Websites</Link>
                            </button>
                            <button className='link-buttons'>                      
                                      <Link href="#free-trial">Free Trial</Link>
                            </button>
                            <button className='link-buttons'>                    
                                        <Link href="#disclaimer">Disclaimer of Warranty</Link>
                            </button>
                            <button className='link-buttons'>                     
                                       <Link href="#fee-changes">Fee Changes</Link>
                            </button>
                            <button className='link-buttons'>                       
                            ...
                            <button className='link-buttons'>                       
                                     <Link href="#prohibited-uses">Prohibited Users</Link>
                            </button>
                            <button className='link-buttons'>                         
                                   <Link href="#service-change">Changes to Service</Link>
                            </button>
                            <button className='link-buttons'>                           
                                 <Link href="#analytics">Analytics</Link>
                            </button>
                            <button className='link-buttons'>                           
                                 <Link href="#amendments">Amendments to Terms</Link>
                            </button>
                            <button className='link-buttons'>                           
                                 <Link href="#minor-use">Use By Minors</Link>
                            </button>
                            <button className='link-buttons'>                            
                                <Link href="#waiver">Waiver and Severability</Link>
                            </button>
                            <button className='link-buttons'>                            
                                <Link href="#accounts">Accounts</Link>
                            </button>
                            <button className='link-buttons'>                            
                                <Link href="#acknowledgement">Acknowledgment</Link>
                            </button>
                        ...
                        <ol>
                            ...
                            <li>
                                <h2 id="comms">2. Communications</h2>
                            ...
                            <li>    
                                <h2 id="minor-use">12. Use by Minors</h2>
                            ...
                            <li>
                                <h2 id="copyright-policy">15. Copyright Policy</h2>
                            ...
                            <li>
                                <h2 id="dmca">16. DMCA Notice and Procedure for Copyright Infringement Claims</h2>
                            ...
                            <li>
                                <h2 id="error-report">17. Error Reporting and Feedback</h2>
                            ...
                            <li>
                                <h2 id="links">18. Links to Other Websites</h2>
                            ...
                            <li>
                                <h2 id="service-change">23. Changes to Service</h2>
