  ...
  return (
    <div className="bg-gray-100">
      ...
      <main className="2xl:w-8/12 xl:flex flex-col mx-auto overflow-x-hidden">
        ...
        {/* WELCOME */}
        <div className="relative text-center mt-20 py-12 md:py-20 p-6 text-white bg-blueTheme flex flex-col gap-3 items-center hero" style={{ top: '-50px', height: 'auto' }}>
          <h1 className="hidden md:block absolute left-1/2 transform -translate-x-1/2 md:text-7xl font-extrabold md:-mt-12 xl:-mt-20 welcome-heading" style={{ fontFamily: "'SavedByZero', sans-serif" }}>
            {/* Welcome Heading */}
          </h1>

          <div className="w-full h-3/4 md:hidden flex justify-center items-center" style={{ marginTop: '250px' }}>
            <Image
        ...
        <div className="w-full text-center py-2 px-4 md:px-12 -mt-8">
          <p className="text-xl md:text-2xl font-bold text-blue-500 mb-4">
            We're more than just a digital agency, We're your strategic partner in growth.
          </p>
        </div>
        ...
        <div className="p-4 sm:p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            ...
            <div className="bg-blueTheme rounded-sm p-6 text-white flex flex-col items-center text-center hover:bg-blue-600 min-h-80 transform transition hover:scale-105">
              <h2 className="text-lg sm:text-xl font-semibold mb-4">Graphic Design</h2>
              <p className="text-base sm:text-lg mb-4">
                We create visually stunning designs that capture attention and convey your brand's message effectively.
              </p>
              <Image src="/images/graphicservices.svg" alt="Graphic Design Services" className="w-full mt-auto object-cover" width={200} height={200} />
            </div>

            {/* Marketing & Sales Card */}
            <div className="bg-blueTheme rounded-sm p-6 text-white flex flex-col items-center text-center hover:bg-blue-600 min-h-80 transform transition hover:scale-105">
              <h2 className="text-lg sm:text-xl font-semibold mb-4">Marketing & Sales</h2>
              <p className="text-base sm:text-lg mb-4">
                Our marketing content is designed to drive traffic, generate leads, and boost conversions.
              </p>
              <Image src="/images/marketing.svg" alt="Marketing Services" className="w-full mt-auto object-cover" width={200} height={200} />
            </div>

            {/* Web/App Development Card */}
            <div className="bg-blueTheme rounded-sm p-6 text-white flex flex-col items-center text-center hover:bg-blue-600 min-h-80 transform transition hover:scale-105">
              <h2 className="text-lg sm:text-xl font-semibold mb-4">Web/App Developing</h2>
              <p className="text-base sm:text-lg mb-4">
                We help you build exceptional digital experiences that engage users and drive business growth.
              </p>
              <Image src="/images/webapp.svg" alt="Web Development" className="w-full mt-auto object-cover" width={200} height={200} />
            </div>

            {/* Administrative Services Card */}
            <div className="bg-blueTheme rounded-sm p-6 text-white flex flex-col items-center text-center hover:bg-blue-600 min-h-80 transform transition hover:scale-105">
              <h2 className="text-lg sm:text-xl font-semibold mb-4">Administrative Services</h2>
              <p className="text-base sm:text-lg mb-4">
                We provide efficient and reliable support from project management and data entry to customer support and virtual assistance.
              </p>
              <Image src="/images/admin.svg" alt="Administrative Services" className="w-full mt-auto object-cover" width={200} height={200} />
            </div>
          </div>
        </div>
        ...
        <div className="p-6 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 justify-center items-center">
            ...
            <button className="bg-blueTheme rounded-sm p-6 text-white text-lg font-semibold flex flex-col items-center text-center shadow-md hover:bg-blue-600 transition h-80 w-60 mx-auto transform hover:scale-105">
              ...
              <Image src="/images/choose.svg" alt="Choose Icon" className="w-48 h-48 mt-28" width={100} height={100} />
            </button>

            {/* Button for Connect */}
            <button className="bg-blueTheme rounded-sm p-6 text-white text-lg font-semibold flex flex-col items-center text-center shadow-md hover:bg-blue-600 transition h-80 w-60 mx-auto transform hover:scale-105">
              <span className="text-2xl">Connect</span>
              <Image src="/images/connect.svg" alt="Connect Icon" className="w-48 h-48 mt-36" width={100} height={100} />
            </button>
        ...
        <section id="contact" className="bg-blueTheme p-4 md:p-10">
          ...
          <div className="bg-white rounded-xl flex flex-col md:flex-row justify-between">
            ...
            <div className="rounded-xl p-4 md:p-10 md:w-1/2">
              <h2 className="font-bold text-black text-3xl mb-6">Contact Us:</h2>
              ...
              <p className="text-md md:text-lg font-bold mb-2">Call or Whatsapp:</p>
              <p className="text-md md:text-lg text-gray-700 mb-4">1-868-710-4296</p>
              ...
              <div className="flex gap-5 mt-6 lg:justify-start items-center">
                ...
                <a href="https://www.linkedin.com/in/uptechincorp/" target="_blank" rel="noopener noreferrer">
                  <Image className="w-10 md:w-8" src="/images/linkedin.svg" alt="linkedin" width={32} height={32} />
                </a>
